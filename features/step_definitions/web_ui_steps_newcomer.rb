...
Тогда(/^проверяю, что файл находится в нужной директории$/) do
  ...
  elsif !Dir.children("/home/pozhiloyuser/Downloads_Chrome_Firefox/Firefox").nil?
    $logger.info("Файл находится по заявленному пути #{Dir.children("/home/pozhiloyuser/Downloads_Chrome_Firefox/Firefox").last}")
...
Тогда(/^проверяю, что имя скачанного файла совпадает с именем файла-установщика, указанного на сайте$/) do
  ...
  $logger.info("Файл находится в нужной директории")
    ...
    link_file_name+'.crdownload'==Dir.children("/home/pozhiloyuser/Downloads_Chrome_Firefox/Firefox").last
    $logger.info("Файл находится в нужной директории")
